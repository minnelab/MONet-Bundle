...
sys.path.insert(0, os.path.abspath("../../MONet_scripts"))
...
project = "MONet"
copyright = "2025, Simone Bendazzoli"
author = "Simone Bendazzoli"

# The full version, including alpha/beta/rc tags
release = MONet.__version__
...
def generate_apidocs(*args):
    ...
    module_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "../..", "MONet"))
    scripts_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "../..", "MONet_scripts"))
