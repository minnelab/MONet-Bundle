...
function check_import {
    echo "Python: "${PY_EXE}""
    ${cmdPrefix}"${PY_EXE}" -W error -W ignore::DeprecationWarning -W ignore::ResourceWarning -c "import MONet"
}

function print_version {
    ${cmdPrefix}"${PY_EXE}" -c 'import MONet; print(MONet.__version__)'  # project-monai/monai#6167
}
