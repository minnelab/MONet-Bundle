...
def get_arg_parser():
    ...
    parser.add_argument('--nnunet_model', type=str, required=True, help='Path to the nnUNet model checkpoint file (e.g., Task09_Spleen.zip).')
...
def main():
    ...
    docker.run(
        ...
        command=[
            "--fold", "0", "--bundle_root", "/model/bundle","--dataset_name_or_id", args.dataset_name_or_id,
            ],
        volumes=[
