...
def main():
    ...
    convert_torchscript_to_pt(
        os.path.join(bundle_root, "MONetBundle", "models", f"fold_{fold}", "model.ts"),
        os.path.join(bundle_root, "MONetBundle", "models", f"fold_{fold}", "model.pt"),
    )
    convert_torchscript_to_pt(
        os.path.join(bundle_root, "MONetBundle", "models", f"fold_{fold}", "model.ts"),
        os.path.join(bundle_root, "MONetBundle", "models", f"fold_{fold}", "checkpoint_epoch=1000.pt"),
    )
    convert_torchscript_to_pt(
        os.path.join(bundle_root, "MONetBundle", "models", f"fold_{fold}", "model.ts"),
        os.path.join(bundle_root, "MONetBundle", "models", f"fold_{fold}", "checkpoint_key_metric=1.0.pt"),
    )
