...
def main():
    ...
    if response.status_code != 200:
        ...
        if args.input_path.endswith(".nii.gz"):
            print(f"Verifying input file: {args.input_path}")
            input_img = sitk.ReadImage(args.input_path)
            ...
            if n_channels != len(required_input_channels):
                ...
                print(f"Input file {args.input_path} is valid for the model {model}.")
